...
public class ItemRequestServiceImpl {
    ...
    void findAllRequestsByRequestor() {
        ...
        List<ItemRequestDto> requestDtoList = itemRequestService.findAllRequestsByRequestor(user1.getId(), 0, 20);
    ...
    void catchNotFoundExceptionWhenFindAllRequestsByRequestorWithNotExistUser() {
        ...
        Exception exception = assertThrows(NotFoundException.class, () -> {
            itemRequestService.findAllRequestsByRequestor(99, 0, 20);
        });
        assertTrue(UserRepository.class.getName().contains(exception.getMessage()));
    }
